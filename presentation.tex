...
\begin{frame}{Dodatne funkcionalnosti}
  \begin{itemize}
...
\begin{frame}{Objava}
  \begin{large}
    {Simultaneous multiple representation editing environment for primary school education\par}
  \end{large}
  \begin{small}
    {Žiga Leber, Matej Črepinšek, Tomaž Kosar\par}
  \end{small}
  \begin{small}
    {VL/HCC 2019}
  \end{small}
